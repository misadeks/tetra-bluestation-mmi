...
# libudev-dev libxkbcommon-dev libfontconfig1-dev libegl-dev libgles-dev
# libgl1-mesa-dri) so their headers + .pc files come across. Re-run this after
# installing any new -dev package on the Pi.
set -euo pipefail
